...
class Google_Client {
  ...
  public function setUserId($user_id) {
    global $apiConfig;
    $apiConfig['oauth2_user_id'] = $user_id;
    // self::$auth->user_id = $user_id;
    self::$auth->setUserId($user_id);
  }
  ...
  public function setGroupId($group_id) {
    global $apiConfig;
    $apiConfig['oauth2_group_id'] = $group_id;
    self::$auth->group_id = $group_id;
  }

  public function getGroupId() {
    return self::$auth->group_id;
  }

  public function setExtraRedirectUrl($extra_redirect) {
    global $apiConfig;
    $apiConfig['oauth2_extra_redirect_url'] = $extra_redirect;
    self::$auth->extra_redirect = $extra_redirect;
  }

  public function getExtraRedirectUrl() {
    return self::$auth->extra_redirect;
  }
