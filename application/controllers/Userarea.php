...
class Userarea extends MY_Controller {
    ...
    public function __construct() {
        ...
        // Get codeigniter object instance - CLIENT LINK
         ...
         * for store user_id which is used in social apis
         ...
         */
            ...
            if($this->CI->session->has_userdata('group_id')) {
                // Set group_id
     ...
     * save net ids for save group

     */

    public function ajax_save_net_ids() {
        if($this->CI->input->post() && !empty($this->CI->input->post('net_ids'))) {

            $this->CI->session->set_userdata('net_ids', $this->CI->input->post('net_ids'));
    ...
    public function connect($network, $user_id = NULL) {
        ...
        if(is_null($user_id)) {
            ...
            $limit_accounts = $this->plans->get_plan_features($user_id, 'network_accounts');

            

            // Get all accounts connected for social network

            $allaccounts = $this->networks->get_all_accounts($user_id, $network);
    ...
    /*---==================== CLIENT LINK ====================--->*/
        ...
        $client_login = (($this->CI->user_id != '') && (isset($this->CI->group_id) && ($this->CI->group_id != '')));
