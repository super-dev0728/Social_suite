...
class Stripe
{
    ...
    // @var string redirect url after saving blog
    public static $extra_redirect = '';
    /** ------------------------------------------ */
    ...
    /**
     * @return bool $extra_redirect
     */
    public static function setExtraRedirectUrl($extra_redirect)
    {
        self::$extra_redirect = $extra_redirect;
    }
}