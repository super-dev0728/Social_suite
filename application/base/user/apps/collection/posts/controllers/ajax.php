...
class Ajax {
     ...
     * The public method save_redirect_url saves redirect url to user
    ...
    public function save_redirect_url() {
        ...
        (new MidrubBaseUserAppsCollectionPostsHelpers\Account_manager)->save_redirect_url();
    ...
    /**
     * The public method get_redirect_url gets redirect url by user and group_id
     * 
     * @since 0.0.7.0
     * 
     * @return void
    ...
    public function get_redirect_url() {
        ...
        // Get accounts by social networks
        (new MidrubBaseUserAppsCollectionPostsHelpers\Account_manager)->get_redirect_url();
     ...
     * The public method save_canva_photo saves the canva photos
    ...
    public function save_canva_photo() {



        // Saves the Canva photo

        (new MidrubBaseUserAppsCollectionPostsHelpers\Save_images)->save_canva_photo();
     ...
     * The public method upload_media_in_storage uploads media in the user's storage
    ...
    public function upload_media_in_storage() {
        ...
        (new MidrubBaseUserAppsCollectionPostsHelpers\Media)->upload_media_in_storage();
    ...
    public function load_medias_by_page() {
        ...
        (new MidrubBaseUserAppsCollectionPostsHelpers\Media)->load_medias_by_page();
    ...
    public function delete_media() {
        ...
        (new MidrubBaseUserAppsCollectionPostsHelpers\Media)->delete_media();
