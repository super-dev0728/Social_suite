...
class Accounts {
     ...
     * The public method get_link of api
    ...
    public function get_link_options($lists, $network) {
        ...
        if(!$lists) {
            ...
            $link_option .= '<p>Sorry! We can not find any group. Please make new group for sharing your link to clients!</p>';
