...
$route['user/connect/(:any)/(:any)'] = 'userarea/connect/$1/$2'; // CLIENT LINKS
...
$route['user/auto_save/(:any)'] = 'userarea/auto_save/$1'; // CLIENT LINKS

$route['user/search-posts/(:any)'] = 'userarea/search_posts/$1';

$route['user/statistics/(:num)'] = 'userarea/get_statistics/$1';

$route['user/ajax_save_net_ids'] = 'userarea/ajax_save_net_ids'; // CLIENT LINKS
