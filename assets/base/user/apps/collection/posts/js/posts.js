...
jQuery(document).ready( function ($) {
    ...
    ********************************/
    ...
    Main.save_redirect_url = function () {
        ...
        $.ajax({
            ...
            success: function (resp) {
                ...
                if (resp.status == 'success') {
                    ...
                    Main.popup_fon('subi', resp.msg, 1500, 2000);

                    return;

                } else {

                    Main.popup_fon('sube', resp.msg, 1500, 2000);
    ...
    Main.load_medias = function (page) {
        ...
        Main.ajax_call(url + 'user/app-ajax/posts', 'POST', data, 'get_media');
     ...
     * @param string url contains the url to convert

     * @param callback contains the function to return
     ...
     * Upload a file in the user's storage
     ...
     * @param object data contains the file information
    ...
    Main.pixabay_save_photo = function (data) {
    ...
    ********************************/
    ...
    Main.methods.composer_publish_post_status = function ( status, data ) {
        ...
        if ( status === 'success' ) {
            ...
            $('.main .midrub-calendar-time-hour').val('08');



            // Set minutes

            $('.main .midrub-calendar-time-minutes').val('00');
            ...
            if ($('.main .composer-url').length > 0 ) {
                ...
                $('.main .composer-url input[type="text"]').val('');
    ...
    Main.methods.account_manager_get_accounts = function ( status, data ) {
        ...
        if ( status === 'success' ) {
            ...
            if ( data.type === 'accounts_manager' ) {
                ...
                // Display client link part

                $('#accounts-manager-popup .manage-link-for-group').html(data.client_link);
     ...
     * Displays the canva saving response
    ...
    ********************************/
    ...
    if ( $( '#calendar' ).length > 0 ) {
        ...
        $( '#calendar' ).fullCalendar({
            ...
            firstDay: $('.posts-page').attr('data-week-starts'),
     ...
     * Generate Login Link and Redirect

     */

    $('#accounts-manager-popup').delegate('#external_group_select', 'change', function () {
...
* @param object options contains the returned data
